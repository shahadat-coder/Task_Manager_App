...
class UpdateTaskStatusScreen extends StatefulWidget {
  ...
  const UpdateTaskStatusScreen(
      {Key? key, required this.task, required this.onUpdate})
      : super(key: key);

  @override
  State<UpdateTaskStatusScreen> createState() => _UpdateTaskStatusSheetState();
}

class _UpdateTaskStatusSheetState extends State<UpdateTaskStatusScreen> {
